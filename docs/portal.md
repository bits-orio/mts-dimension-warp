...
- A finish line. Research `stabilize-dimensions` to win. The race is ranked but non-terminal, so the first team to finish stops warping and roams free while everyone else races on.
...
- [Multi-Team Support](https://mods.factorio.com/mod/multi-team-support) is required. One server, one seed, a private world for every team.
- [Brave New MTS](https://mods.factorio.com/mod/brave-new-mts) brings remote-only, character-free play, also built on MTS.
...
- [wretlaw120](https://mods.factorio.com/user/wretlaw120) / [Beacon Rebalance](https://mods.factorio.com/mod/wret-beacon-rebalance-mod) supplied the factory beacon graphic.
- [Quezler](https://mods.factorio.com/user/Quezler) / [Warptorio2 warp harvester indoor drill placement](https://mods.factorio.com/mod/warptorio2-warp-harvester-indoor-drill-placement) solved placing drills in undeployed harvesters.
...
- [Space icons created by smalllikeart, Flaticon](https://www.flaticon.com/free-icons/space) for the blackhole toggle icon.
