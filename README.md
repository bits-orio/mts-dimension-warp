...
Everything that makes the warp *feel* the way it does is Anakhon's work, written from scratch: the platform that carries your whole base between worlds, the dimension techs, the harvesters, the art and sound, the relentless pace of Gleba. This fork does exactly one thing on top of that: it makes the experience **per-team**, so it can be played as a fair race on [Multi-Team Support](https://github.com/bits-orio/multi-team-support).
...
- **Its own warp world, on its own clock**, so teams warp independently and never in lockstep.
...
- **[Multi-Team Support](https://github.com/bits-orio/multi-team-support)** is required.
...
### People and mods
* [Hurricane046](https://mods.factorio.com/user/Hurricane046) designed the Radio Station.
* [hgschmie](https://mods.factorio.com/user/hgschmie) / [miniloader-redux](https://mods.factorio.com/mod/miniloader-redux) supplied the loader graphics and part of the loader code.
* [wretlaw120](https://mods.factorio.com/user/wretlaw120) / [Beacon Rebalance](https://mods.factorio.com/mod/wret-beacon-rebalance-mod) supplied the beacon graphic used for the factory beacon.
* [Quezler](https://mods.factorio.com/user/Quezler) / [Warptorio2 warp harvester indoor drill placement](https://mods.factorio.com/mod/warptorio2-warp-harvester-indoor-drill-placement) solved placing drills in harvesters when not deployed.
* [Nonoce](https://mods.factorio.com/user/NONOCE) / [Warptorio](https://mods.factorio.com/mod/warptorio), the original mod.
* [PyroFire](https://mods.factorio.com/user/PyroFire) / [Warptorio2](https://mods.factorio.com/mod/warptorio2), which expanded and improved that first version.
...
* [Space icons created by smalllikeart, Flaticon](https://www.flaticon.com/free-icons/space) for the blackhole icon toggle.
* [Supply icons created by Freepik, Flaticon](https://www.flaticon.com/free-icons/supply) for the supplies icon.
